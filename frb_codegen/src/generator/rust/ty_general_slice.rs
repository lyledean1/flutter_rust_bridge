...
type_rust_generator_struct!(TypeGeneralSliceGenerator, IrTypeGeneralSlice);

impl TypeGeneralSliceGenerator<'_> {
...
impl TypeRustGeneratorTrait for TypeGeneralSliceGenerator<'_> {
    fn wire2api_body(&self) -> Acc<Option<String>> {
        Acc {
            wasm: Some(TypeGeneralSliceGenerator::WIRE2API_BODY_WASM.to_owned()),
            io: Some(TypeGeneralSliceGenerator::WIRE2API_BODY_IO.to_owned()),
            ..Default::default()
        }
    }
